...
export default async function FocusPage({
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 md:p-12 min-h-[calc(100vh-100px)] flex flex-col items-center justify-center space-y-12">
                    ...
                    <div className="flex flex-col gap-2">
                        {quests.slice(0, 3).map((q) => (
                            <a
                                ...
                                className="glass p-4 rounded-2xl flex items-center justify-between hover:bg-white/10 transition border-white/5"
                            >
